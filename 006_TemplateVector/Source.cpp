...
int main() {
    ...
    //v2.add_element_end(771.5);
    //v2.add_element_end(51.3);
    //v2.print();

    vector<point<int>> points;
    points.add_element_end(point<int>(3, 4, 5));
    points.add_element_end(point<int>(9, 3, 7));
    points.add_element_end(point<int>(-3, 1, -5));
    points.add_element_end(point<int>(-11, 4, 8));
    points.add_element_end(point<int>(7, 1, 9));
    points.print();
