...
// 1. Додаванян нового елмента на вершину
// 2. Перегляд елемента на вершині без його видалення
// 3. Перегляд елемента на вершині з його видаленням
// 4. Перевірка, чи стек пустий
// 5. Очищення стеку
